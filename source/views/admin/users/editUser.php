<div class="ui container" style="margin-top: 60px;margin-bottom: 60px;">
    <div class="ui large header">Editar Usuário</div>
    ...
    <form class="ui form">
        ...
        <div class="field">
            <label>Nome</label>
            <div class="field">
                <input type="text" name="primeiroNomeInput" placeholder="Primeiro Nome" value="José Abreu">
            </div>
        </div>
        <div class="fields">
        ...
        <a href="<?= BASE_URL; ?>adminUsers" class="ui fluid large green button" tabindex="1">Salvar</a>
    </form>
</div>
