<link rel="stylesheet" type="text/css" href="<?= BASE_URL; ?>assets/css/minhaconta.css">
<div style="margin-bottom: 50px;" class="ui middle aligned center aligned grid">
    <div id = "container">
        <div class="ui text container">
            <form class="ui form">
                ...
                <div class="field">
                    <label>Nome</label>
                    <div class="field">
                        <input type="text" name="primeiroNomeInput" placeholder="Nome" value="José Abreu">
                    </div>
                </div>
                <div class="fields">
                    <div class="seven wide field">
                        <label>CPF</label>
                        <input type="text" name="cpfInput" maxlength="11" placeholder="Número do CPF" value="11111111109">
                    </div>
                    <div class="three wide field">
                        <label>Dia</label>
                        <input type="text" name="diaInput" maxlength="2" placeholder="" value="01">
                    </div>
                    <div class="six wide field">
                        ...
                        <div class="two fields">
                            ...
                            <div class="field">
                                <input type="text" name="anoInput" maxlength="4" placeholder="Ano" value="1995">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="field">
                    ...
                    <div class="fields">
                        <div class="twelve wide field">
                            <input type="text" name="endereçoInput" placeholder="Endereço" value="Vale das Rosas">
                        </div>
                        <div class="four wide field">
                            <input type="text" name="numeroEnderecoInput" placeholder="Número" value="123">
                        </div>
                    </div>
                </div>
                <div class="two fields">
                    <div class="field">
                        ...
                        <select class="ui fluid dropdown">
                            <option value="EG">Estrangeiro</option>
                    ...
                    <div class="field">
                        ...
                        <div class="ui fluid search selection dropdown">
                            ...
                            <div class="text"><i class="br flag"></i>Brazil</div>
                            <div class="menu">
                ...
                <h4 class="ui dividing header">Dados de Acesso</h4>
                <div class="field">
                    <label>E-mail</label>
                    <input type="email" name="emailInput" maxlength="50" placeholder="" value="jose@gmail.com">
                </div>
                <div class="field">
                    <label>Senha Antiga</label>
                    <input type="password" name="senhaInput" maxlength="20" placeholder="">
                </div>
                <div class="field">
                    <label>Nova Senha</label>
                    <input type="password" name="senhaInput" maxlength="20" placeholder="">
                </div>
                <div class="ui green button">Alterar</div>
                <div class="ui segment">
                    <div class="field">
                        <div class="ui toggle checkbox">
                            <input type="checkbox" name="enviarPorEmail" tabindex="0" class="hidden">
                            <label>Desejo receber notificações do resultado dos jogos por e-mail</label>
                        </div>
                    </div>
                </div>
                <a style="margin-bottom: 15px;" href="<?= BASE_URL; ?>" class="ui fluid large green button" tabindex="1">Salvar</a>
            </form>
        </div>
    </div>